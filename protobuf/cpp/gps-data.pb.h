...
#ifndef PROTOBUF_gps_2ddata_2eproto__INCLUDED
#define PROTOBUF_gps_2ddata_2eproto__INCLUDED
...
enum GPSFix_Status {
  ...
  GPSFix_Status_GPSFix_Status_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  GPSFix_Status_GPSFix_Status_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
...
class GPSFix_Uncertainties : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:vutura.gps.GPSFix.Uncertainties) */ {
 public:
  ...
  inline GPSFix_Uncertainties* New() const PROTOBUF_FINAL { return New(NULL); }

  GPSFix_Uncertainties* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend struct  protobuf_gps_2ddata_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class GPSFix : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:vutura.gps.GPSFix) */ {
 public:
  GPSFix();
  virtual ~GPSFix();
  ...
  inline GPSFix* New() const PROTOBUF_FINAL { return New(NULL); }

  GPSFix* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
template <> struct is_proto_enum< ::vutura::gps::GPSFix_Status> : ::google::protobuf::internal::true_type {};
template <>
...
#endif  // PROTOBUF_gps_2ddata_2eproto__INCLUDED
