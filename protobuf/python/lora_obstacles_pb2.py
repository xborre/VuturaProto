...
_TAGSSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='setWarnings',
    full_name='vutura.obstacles.TagsService.setWarnings',
    index=3,
    containing_service=None,
